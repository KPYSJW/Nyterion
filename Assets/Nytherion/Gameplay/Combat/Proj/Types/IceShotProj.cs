...
namespace Nytherion.GamePlay.Combat
{
    ...
    public class IceShotProj : MonoBehaviour, IProj, IProjModifier
    {
        ...
        public bool OnHit(Collider2D target)
        {
            ...
            if (target.CompareTag("Enemy"))
            {
                ...
                {
                    GameObject effectObj = ObjectPoolManager.Instance.SpawnFromPool("IceShotHitVFX", hitPoint, rotation);
                }
            }
        ...
        private void TriggerSplit(Collider2D target)
        {
            ...
            for (int i = 0; i < splitCount; i++)
            {
                ...
                if (fragment != null)
                {
                    ...
                    if (fragment.TryGetComponent<IceShotProj>(out IceShotProj childProj))
                    {
