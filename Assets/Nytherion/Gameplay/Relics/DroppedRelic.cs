...
namespace Nytherion.GamePlay.Relics
{
    ...
    public class DroppedRelic : MonoBehaviour
    {
        ...
        private RarityWorldLightEffect rarityLightEffect;
        private GachaMeteorEffect meteorEffect;
        ...
        private void Awake()
        {
            ...
            rarityLightEffect = GetComponent<RarityWorldLightEffect>();
            meteorEffect = GetComponent<GachaMeteorEffect>();
        ...
        public void Init(RelicData data, Transform player, RelicManager manager)
        {
            ...
            if (shouldConcealRelic)
            {
                ...
                {
                    rarityLightEffect = gameObject.AddComponent<RarityWorldLightEffect>();
                }
        ...
        private void StartLaunch()
        {
            ...
            {
                meteorEffect = gameObject.AddComponent<GachaMeteorEffect>();
            }
