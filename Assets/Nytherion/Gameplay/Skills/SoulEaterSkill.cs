    ...
    public class SoulEaterSkill : SkillBase
    {
        ...
        protected override void Activate()
        {
            if (skillData != null)
            {
                ...
                if (projectileInstance != null && projectileInstance.TryGetComponent(out SoulEaterProjectile projectile))
                {
                ...
                {
                    Debug.LogError($"[SoulEaterSkill] 풀에서 오브젝트를 가져오지 못했거나 SoulEaterProjectile이 없습니다!");
                }
            }
        }
