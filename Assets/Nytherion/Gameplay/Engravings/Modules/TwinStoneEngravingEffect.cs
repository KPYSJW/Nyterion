...
namespace Nytherion.Gameplay.Engravings.Modules
{
    ...
    /// </summary>
    [Serializable]
    public class TwinStoneEngravingEffect : EngravingEffectBase
    {
        ...
        public override void ApplyEffect(PlayerManager playerManager, int level)
        {
            ...
            if (cachedEventManager != null)
            {
                ...
                cachedEventManager.OnPlayerRangedAttack += HandleRangedAttack;
                Debug.Log($"[TwinStoneEngravingEffect] 트윈스톤 효과 적용 (레벨: {currentLevel})");
            }
        }
        ...
        public override void RemoveEffect(PlayerManager playerManager, int level)
        {
            ...
            {
                cachedEventManager.OnPlayerRangedAttack -= HandleRangedAttack;
                Debug.Log("[TwinStoneEngravingEffect] 트윈스톤 효과 해제");
            }
        }
