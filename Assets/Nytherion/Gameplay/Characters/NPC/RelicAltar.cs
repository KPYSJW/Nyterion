...
{
    public class RelicAltar : MonoBehaviour, IInteractable
    {
        public InteractableType Type => InteractableType.RelicAltar;
        ...
        {
            Debug.Log($"[RelicAltar] Interact() 호출됨 - IsInteractable: {IsInteractable}");
