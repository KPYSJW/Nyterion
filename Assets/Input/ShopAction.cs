...
//     version 1.14.0
//     from Assets/Input/ShopAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/ShopAction.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ShopAction: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Sell"",
            ""id"": ""995ff6c7-98fb-4c4d-a645-394522fb6e92"",
            ""actions"": [
                {
                    ""name"": ""SellectAll"",
                    ""type"": ""Value"",
                    ""id"": ""e457000e-6e37-44c9-9ed2-8a8c8a2782ab"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""26338376-6121-4d36-9176-82f5add09e10"",
                ...
                {
                    ""name"": """",
                    ""id"": ""36fd1504-fff0-41fd-ae70-f9d1e441962b"",
    ...
    ""controlSchemes"": []
        ...
        m_Sell_SellectAll = m_Sell.FindAction("SellectAll", throwIfNotFound: true);
    }

    ~@ShopAction()
    {
        UnityEngine.Debug.Assert(!m_Sell.enabled, "This will cause a leak and performance issues, ShopAction.Sell.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Sell_SellectAll;
    /// <summary>
    /// Provides access to input actions defined in input action map "Sell".
    /// </summary>
    public struct SellActions
    {
        private @ShopAction m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public SellActions(@ShopAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Sell/SellectAll".
        /// </summary>
        public InputAction @SellectAll => m_Wrapper.m_Sell_SellectAll;
        /// <summary>
        ...
        public void AddCallbacks(ISellActions instance)
        {
            ...
            @SellectAll.started += instance.OnSellectAll;
            @SellectAll.performed += instance.OnSellectAll;
            @SellectAll.canceled += instance.OnSellectAll;
        }
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "SellectAll" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnSellectAll(InputAction.CallbackContext context);
    }
}
